...
class _PostsApi implements PostsApi {
  ...
  @override
  Future<SimpleResDto> deletePost(int postId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<SimpleResDto>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SimpleResDto.fromJson(_result.data!);
    return value;
  }
